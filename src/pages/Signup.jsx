...
const Signup = () => {
  ...
  return (
    ...
    <div className='w-full h-screen'>
      <img className='hidden sm:block absolute w-full h-full object-cover' src="https://assets.nflxext.com/ffe/siteui/vlv3/73334647-ad51-42a9-b07b-93298cc2a8e1/8efb7d2a-4d43-4729-9714-7a5c1f12cf45/KE-en-20230605-popsignuptwoweeks-perspective_alpha_website_large.jpg" alt="/" />
